...
describe('Gemini Client (client.ts)', () => {
  ...
  beforeEach(async () => {
    ...
    mockConfig = {
      ...
      getExperimentalAgentHistoryTruncationThreshold: vi.fn().mockReturnValue(30),
  ...
  describe('sendMessageStream', () => {
    it('calls AgentHistoryProvider.manageHistory when history truncation is enabled', async () => {
      // Arrange
      mockConfig.isExperimentalAgentHistoryTruncationEnabled = vi.fn().mockReturnValue(true);
      const manageHistorySpy = vi.spyOn(
