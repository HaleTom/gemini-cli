...
export class GeminiClient {
  ...
  constructor(private readonly context: AgentLoopContext) {
    ...
    this.agentHistoryProvider = new AgentHistoryProvider(this.config, {
      truncationThreshold: this.config.getExperimentalAgentHistoryTruncationThreshold(),
      retainedMessages: this.config.getExperimentalAgentHistoryRetainedMessages(),
    });
